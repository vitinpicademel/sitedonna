            ...
            <div className="bg-gradient-to-br from-[#1a1410] to-[#0a0806] p-8 border border-[#3d2f1f] rounded-xl shadow-2xl hover:shadow-3xl transition-all duration-500 group relative overflow-hidden">
              ...
              <div className="mt-6">
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex items-center gap-2 bg-[#b8956a]/10 backdrop-blur-sm px-3 py-2 rounded-lg w-full sm:w-auto sm:justify-start justify-center">
                  ...
                  <Button
                    ...
                    className="bg-[#3d2f1f] hover:bg-[#4d3f2f] text-white px-4 py-2 transition-all duration-300 hover:scale-105 w-full sm:w-auto"
                  >
                    Próximo →
                  </Button>
                </div>
