  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? "bg-[#1a1410]/90 backdrop-blur-xl border-b border-[#3d2f1f] shadow-2xl"
          : "bg-black/30 backdrop-blur-lg border-b border-white/30"
      }`}
    >
      {/* Moldura com blur - overlay decorativo bem próximo das letras */}
      <div className="absolute inset-x-48 inset-y-0 bg-gradient-to-r from-[#c89968]/5 via-transparent to-[#c89968]/5 pointer-events-none"></div>
      
      {/* Borda superior com gradiente bem próxima das letras */}
      <div className="absolute top-0 left-64 right-64 h-px bg-gradient-to-r from-transparent via-[#c89968]/50 to-transparent"></div>
      
      {/* Borda inferior com gradiente bem próxima das letras */}
      <div className="absolute bottom-0 left-64 right-64 h-px bg-gradient-to-r from-transparent via-[#c89968]/30 to-transparent"></div>
      {/* Top Bar removido por solicitação */}

      {/* Main Navigation - dividida com logo central */}
      <div className="container mx-auto px-4">
        <div className="relative">
          {/* Moldura interna com blur bem próxima das letras */}
          <div className="absolute inset-x-20 inset-y-0 bg-gradient-to-r from-[#c89968]/10 via-transparent to-[#c89968]/10 rounded-2xl backdrop-blur-sm border border-[#c89968]/20 shadow-inner"></div>
          ...
          {/* Botão Mobile */}
          <button 
            className="lg:hidden text-white ml-auto p-2 rounded-lg hover:bg-white/10 transition-all duration-300" 
          ...
          {/* Elementos decorativos da moldura bem próximos das letras */}
          <div className="absolute top-2 left-16 w-2 h-2 bg-[#c89968]/30 rounded-full animate-pulse"></div>
          <div className="absolute top-2 right-16 w-2 h-2 bg-[#c89968]/30 rounded-full animate-pulse"></div>
          <div className="absolute bottom-2 left-16 w-2 h-2 bg-[#c89968]/30 rounded-full animate-pulse"></div>
          <div className="absolute bottom-2 right-16 w-2 h-2 bg-[#c89968]/30 rounded-full animate-pulse"></div>
        </div>
      </div>
